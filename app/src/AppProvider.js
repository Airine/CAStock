...
class AppProvider extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            user: cookies.get('user') || true, // skip login page
            address: cookies.get('address') || "0x4e00C7DeFBDc1eD6AbE2cCC4e5f0A2531Fe7B9b1",
            password: cookies.get('password') || "0xbc8e5ca8f3cc80fd52bff564853a2ae09343ae8c3535211b4acd5b4dce39a5c6",
            loading: true,
            loginModal: false,
            registerModal: false,
        };
